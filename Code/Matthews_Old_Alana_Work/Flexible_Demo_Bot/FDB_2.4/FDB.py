...
#▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
        ...
        if len(sys.argv) > 1:
            ...
            try:
                ...
                LastWasQ = False#was the last line read a question line?

                initial = ["",""]# a special tuple, used in the event that the first line is an answer to an unasked question

                current = ["",""]#a tuple containing two blank strings, Question and answer
                ...
                for line in File:
                    ...
                    if line[:8] == "Program:":
                        ...
                        if first:#this means either this is the first line, or a user opening statement must be stored
                            first = False#this means that it will only be first once
                            if initial[0] != "":#the case for storing
                                self.statements.append(initial)

                        if not first and not LastWasQ:#in this case, the answer to the previous question was just recorded, so the previous question can now be stored.
                            self.statements.append(current)
                            current = ["",""]#resets current question answer pair.

                        current[0] = current[0] + " " + line[8:].rstrip().lstrip()#this allows for multiple-line questions

                        LastWasQ = True

                    elif line[:5] == "User:":

                        if first:#this means that the first answer has come without a question
                            initial[1] = initial[1] + " " + line[5:].rstrip().lstrip()
                        else:#this is simply an answer to the previous question
                            current[1] = current[1] + " " + line[5:].rstrip().lstrip()#this allows for multiple-line answers
                ...
                self.statements.append(current)#add the final as-of-yet-un-added queston/answer pair to the storage object.
...
#▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
    ...
    def get(self):
        return "Flexible Demo Bot Version 2.4"#used so that if someone tries a get method on this bot (using a browser, for example) they see this message
