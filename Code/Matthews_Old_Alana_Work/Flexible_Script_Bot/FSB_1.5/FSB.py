...
class FSB(Bot):
    ...
    def get(self):
        return "Flexible Script Bot Version 1.5"#used so that if someone tries a get method on this bot (using a browser, for example) they see this message
...
#▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
        ...
        if (Type[:8] == "multiple"):#this should be for situations where there is a set of acceptable answers, and choosing one or more answers is valid, doing otherwise is not
            try:
                temp1 = int(Type[8:].split("-")[0])#the total number of options
                temp2 = int(Type[8:].split("-")[1])#how many options the user can pick at once

                #the plan is that each multiple choice option will be mumerically relayed. The user must then simply give a positive integer answer.

                digits = answer.split(" ")

                if len(digits) > temp2:#if there are more than the maximum acceptable number of options
                    return False

                for i in digits:
                    if int(i) > temp1:#if a non-valid option is chosen
                        return False
...
#▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
        ...
        if BOT_NAME in request_data['current_state']['bot_states'] and request_data['current_state']['state']['last_bot'] == BOT_NAME:#this resets everything if the user starts speaking to another bot, or if the user has never contacted this bot before, or if the previous survey has completed
            Attributes = request_data['current_state']['bot_states'][BOT_NAME]#retrieves this bot's attribute list (if it exists)
            if Attributes['QNum'] > 0 and Attributes['Complete'] == False:
                print("Currently on Question Number: " + str(Attributes['QNum']) + ".")
            elif Attributes['QNum'] == 0 and Attributes['Complete'] == False:
                print("Questioning has not yet begun, due to a valid file not yet being recieved.")
                Attributes['FileName'] = Input
            else:#this will happen if a previous survey is complete
                print("A previous survey has completed")
                Attributes['Answers'] = []#this will hold all the answers
                Attributes['QNum'] = 0
                Attributes['FileName'] = Input
                Attributes['Complete'] = False
...
#▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
        ...
        try:
            ...
            print("beginning to read from file: " + Attributes['FileName'])
            ...
            print("finished reading from file: " + Attributes['FileName'])
...
#▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
        ...
        if Attributes['QNum'] > 0 and Attributes['QNum'] <= len(Questions) and len(Questions) > 0:#in this scenario, it's time to answer questions
            ...
            self.response.result = "That's it, you have answered all questions! You can now try another Survey."
            ...
            #now, the system needs a reset. The next time the user speaks to this bot, it must be as if they had never spoken before.
            ...
            print("QNum is: " + str(Attributes['QNum']))
