        ...
        if len(sys.argv) > 1:
            ...
            try:
                ...
                for line in File:
                    ...
                    if line[:8] == "Program:":
                        #case for question
                        Question = Question + " " + line[8:].rstrip().lstrip()#this allows for multiple-line questions
                    elif line[:5] == "User:":
                        #case for expected answers
                        Answer = Answer + " " +line[5:].rstrip().lstrip()
                        self.statements.append((Question, Answer))#adds the question answer pair as a tuple
                        Question = ""#by resetting the variables, it ensures previous answers aren't overwritten.
                        Answer = ""
                    else:
                ...
                #the above code should work for alternating Question/answer pairs, irrespective of whether it starts with a program or user input, but it must END with an answer.

                if Question != "" and Answer == "":
                    self.statements.append((Question, Answer))#this code now will allow it to parse files which end on questions

                elapsed_time = time.time() - timeval

                print("Elapsed time for the file-reading process (1) is " + str(elapsed_time))

                print("finished reading from file: " + sys.argv[1])#JUST FOR 2.3 TEST PURPOSES
...
#▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
    ...
    def evaluate_similarity(self,Expected,Actual):
        ...
        sub_timeval = time.time()#JUST FOR 2.3 TEST PURPOSES
        ...
        elapsed_time = time.time() - sub_timeval

        print("Elapsed time for the program's sentence simplification process (4) is " + str(elapsed_time))#JUST FOR 2.3 TEST PURPOSES
        ...
        print("Elapsed time for the program's sentence vectorisation process (5) is " + str(elapsed_time))#JUST FOR 2.3 TEST PURPOSES
        ...
        print("Elapsed time for the program's cosine simularity and length comparison process (6) is " + str(elapsed_time))#JUST FOR 2.3 TEST PURPOSES

        return len_ratio*cos_val#this will be no higher than 1.0, and no lower than -1.0
...
#▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
        ...
        if Attributes['QNum'] < len(self.statements):#in this scenario, it's time to ask a question
            ...
            self.response.result = self.statements[Attributes['QNum']][0].rstrip().lstrip()#access the first part of the question/asnwer tuple
...
#▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣
        ...
        print("Elapsed time for the program's context-evaluation process (3) is " + str(elapsed_time))#JUST FOR 2.3 TEST PURPOSES

        #here, the program evaluates the user input

        timeval = time.time()#JUST FOR 2.3 TEST PURPOSES

        #▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣simuluarity analysis begins here


        if Attributes['QNum'] > 0 and Attributes['QNum'] <= len(self.statements):#outside of this, there is no question to answer, so evaluation is a waste of time
            ...
            if self.evaluate_similarity(Expected,Actual) < 0.5:
                Valid = False

        #▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣simularity analysis ends here
        ...
        print("Elapsed time for the program's input-evaluation process (7) is " + str(elapsed_time))#JUST FOR 2.3 TEST PURPOSES
